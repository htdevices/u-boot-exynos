...
#define CONFIG_SECURE_KERNEL_BASE	(CONFIG_SYS_SDRAM_BASE + 0x8000)
#define CONFIG_SECURE_KERNEL_SIZE	0x400000
#define CONFIG_SECURE_ROOTFS_BASE	(CONFIG_SYS_SDRAM_BASE + 0x1000000)
...
#define USBD_DOWN_ADDR		CONFIG_SYS_SDRAM_BASE
...
#define CONFIG_SYS_PROMPT		"Exshields # "
...
#define CONFIG_IDENT_STRING		" for HTD-Exshields"
...
#define MACH_TYPE			3992	/* Exshields */
